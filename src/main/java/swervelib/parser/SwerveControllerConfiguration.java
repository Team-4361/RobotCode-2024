...
public class SwerveControllerConfiguration {
    ...
    public SwerveControllerConfiguration(SwerveDriveConfiguration driveCfg, PIDFConfig headingPIDF, double angleJoyStickRadiusDeadband, double maxSpeedMPS) {
        this.maxAngularVelocity = calculateMaxAngularVelocity(maxSpeedMPS, Math.abs(driveCfg.moduleLocationsMeters[0].getX()), Math.abs(driveCfg.moduleLocationsMeters[0].getY()));

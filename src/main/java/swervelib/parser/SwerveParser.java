...
public class SwerveParser {
    ...
    public SwerveDrive createSwerveDrive(double maxSpeed) {
        return createSwerveDrive(SwerveMath.createDriveFeedforward(physicalPropertiesJson.optimalVoltage, maxSpeed, physicalPropertiesJson.wheelGripCoefficientOfFriction), maxSpeed);
    }
     ...
     * @return {@link SwerveDrive} instance.
     */
    public SwerveDrive createSwerveDrive(SimpleMotorFeedforward driveFeedforward, double maxSpeed, double angleMotorConversionFactor, double driveMotorConversion) {
        physicalPropertiesJson.conversionFactor.angle = angleMotorConversionFactor;
        physicalPropertiesJson.conversionFactor.drive = driveMotorConversion;
    ...
    public SwerveDrive createSwerveDrive(SimpleMotorFeedforward driveFeedforward, double maxSpeed) {
        ...
        return new SwerveDrive(swerveDriveConfiguration, controllerPropertiesJson.createControllerConfiguration(swerveDriveConfiguration, maxSpeed), maxSpeed);
    }
}

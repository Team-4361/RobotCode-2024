...
public class SwerveModule {
     ...
     */
    public Cache<Double> absolutePositionCache;
    /**
     ...
     */
    private SwerveAbsoluteEncoder absoluteEncoder;
    /**
     ...
     */
    public SwerveModule(int moduleNumber, SwerveModuleConfiguration moduleConfiguration, SimpleMotorFeedforward driveFeedforward) {
        //    angle = 0;
        //    speed = 0;
        //    omega = 0;
        //    fakePos = 0;
        ...
        noEncoderWarning = new Alert("Motors", "There is no Absolute Encoder on module #" + moduleNumber, Alert.AlertType.WARNING);
        encoderOffsetWarning = new Alert("Motors", "Pushing the Absolute Encoder offset to the encoder failed on module #" + moduleNumber, Alert.AlertType.WARNING);
    ...
    public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop, boolean force) {
        ...
        // Cosine compensation.
        double velocity = configuration.useCosineCompensator ? getCosineCompensatedVelocity(desiredState) : desiredState.speedMetersPerSecond;
    ...
    private double getCosineCompensatedVelocity(SwerveModuleState desiredState) {
        ...
        cosineScalar = Rotation2d.fromDegrees(desiredState.angle.getDegrees()).minus(Rotation2d.fromDegrees(getAbsolutePosition())).getCos(); // TODO: Investigate angle modulus by 180.
    ...
    public void setAngleMotorBrake(boolean brake) {
        angleMotor.setMotorBrake(brake);
    }
